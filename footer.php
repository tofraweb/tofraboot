        ...
        <footer class="g-bg-color--dark">
            ...
            <div class="container g-padding-y-50--xs">
                <div class="row">
                    <div class="col-xs-6">
                        <a href="index.html">
                            <img class="g-width-100--xs g-height-auto--xs" src="<?php echo get_template_directory_uri();?>/img/logo.png" alt="Megakit Logo">
                        </a>
                    </div>
                    <div class="col-xs-6 g-text-right--xs">
                        <p class="g-font-size-14--xs g-margin-b-0--xs g-color--white-opacity-light"><a href="http://www.tofraweb.com">TofraBoot</a> Wordpress Theme developed by: <a href="http://www.tofraweb.com/">TofraWeb</a></p>
                    </div>
                </div>
            </div>
            <!-- End Copyright -->
